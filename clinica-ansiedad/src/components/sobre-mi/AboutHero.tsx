                ...
                <div className="grid lg:grid-cols-12 gap-16 items-center">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-navy font-medium leading-relaxed mb-8 text-balance">
                            Soy Joan Ramon Soto Cifuente, psicoanalista especialista en ansiedad en Barcelona, fundador de la Clínica de la Ansiedad Catalunya y psicoterapeuta psicoanalítico con más de 30 años de experiencia clínica.
                        </p>
