        ...
        <section className="relative min-h-[90vh] flex items-center bg-cream overflow-hidden pt-32 pb-20">
            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
                ...
                >
                    ...
                    >
                        Terapia <span className="text-gold italic font-medium">rigurosa</span> para superar la ansiedad.
                    </motion.h1>
                    ...
                    >
                        Desde 1993 ayudamos a resolver la raíz del sufrimiento emocional. Un proceso clínico personalizado bajo la dirección del <strong className="font-semibold text-navy">Dr. Joan Ramon Soto</strong> para recuperar tu equilibrio vital.
                    </motion.p>
