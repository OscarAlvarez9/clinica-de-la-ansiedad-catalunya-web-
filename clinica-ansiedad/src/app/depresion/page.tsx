        ...
        <section className="py-20 md:py-28 px-4 md:px-8 bg-white">
          <div className="container mx-auto max-w-4xl">
            ...
            >
              ...
              <motion.p variants={inView}>
                En nuestra consulta de Barcelona (Canet de Mar, comarca del Maresme) he visto a personas brillantes convencidas de que la depresión era un defecto suyo. No lo es. Es una señal —dura, dolorosa— pero una señal que, bien descifrada, abre la puerta a una transformación real. Como psicólogo especialista en depresión en Barcelona, trato la depresión y ansiedad con psicoterapia psicoanalítica, también disponible como{" "}<Link href="/terapia-online" className="text-gold hover:text-gold/80 underline underline-offset-2">terapia online</Link> para pacientes de toda Catalunya —Girona, Lleida, Tarragona— y toda España.
              </motion.p>
            </motion.div>
          </div>
        </section>
